...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.FavoriteCount = field.NewInt64(tableName, "favorite_count")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.FavoriteCount = field.NewInt64(table, "favorite_count")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["favorite_count"] = c.FavoriteCount
